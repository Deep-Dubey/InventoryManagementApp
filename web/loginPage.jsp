...
<html>
    ...
    <body background="image1.jpg">
        <form action="Login" method="post">
            <div class="container">
                <div class="omb_login">
                    <h3 class="omb_authTitle"><a href="loginPage.jsp">Login</a>  || <a href="register.jsp">Sign up</a></h3>
                    <div class="row omb_row-sm-offset-3 omb_socialButtons">
                        ...
                        <div class="col-xs-4 col-sm-2">
                            <a href="https://twitter.com/i/flow/login?input_flow_data=%7B%22requested_variant%22%3A%22eyJsYW5nIjoiZW4ifQ%3D%3D%22%7D" class="btn btn-lg btn-block omb_btn-twitter">
                                <i class="fa fa-twitter visible-xs"></i>
                                <span class="hidden-xs">Twitter</span>
                            </a>
                        </div>	
                        <div class="col-xs-4 col-sm-2">
                            <a href="https://www.google.com/account/about/" class="btn btn-lg btn-block omb_btn-google">
