...
<html lang="en">
    ...
    <body background="image1.jpg" onload="showCartValue()">
                    ...
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        ...
                        <div class="btn-toolbar mb-2 mb-md-0">
                            <div class="btn-group me-2">
                                <a href="ShowProductsForOrder"><button type="button" class="btn btn-outline-danger">Place New Order</button></a>
                                ...
                                <c:if test='${netOrders > 0}'>
                                    <c:forEach items="${requestScope.orders}" var="order">
                                        <tr>
                                            ...
                                            <td><i class="fa fa-inr"></i><c:out value="${order.getOrderValue()}"></c:out></td>
                                            <td><i class="fa fa-inr"></i><c:out value="${order.getTaxAmount()}"></c:out></td>
                                            <td><c:out value="${order.getDestinationCity()}"></c:out></td>
                                            <td><c:out value="${order.getDestinationCountry()}"></c:out></td>
                                            <td><a class="fa fa-edit"  href='EditOrder?orderId=<c:out value="${order.getOrderId()}"></c:out>'></a>
                                                <a class="fa fa-archive"  href='ArchiveOrder?orderId=<c:out value="${order.getOrderId()}"></c:out>'></a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </c:if>
