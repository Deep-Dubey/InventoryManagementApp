...
public class UserService {
    ...
    public static User validateLoginCredentials(User user) {
        ...
        try {
            ...
            String sql = "SELECT userName,password,firstName,lastName,email,phoneNumber FROM users_old"
    ...
    public static boolean registerUser(User myUser) {
        ...
        try {
            ...
            String sql = "INSERT INTO users_old (userName, password, firstName, lastName, email, phoneNumber)\n"
                    + "VALUES (?,?,?,?,?,?)";
