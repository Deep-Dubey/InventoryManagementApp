...
public class OrderServices {
    ...
    public static ArrayList getAllOrders() {
        ...
        try {
            ...
            String sql = "select * from orderinventories.order_old o,customer_old c where o.customerId=c.customerId";
    ...
    public static Order getOrder(String strOrderId) {
        ...
        try {
            ...
            con = ConnectionManager.getConnection();
            String sql ="SELECT * FROM orderinventories.order_old o,orderinventories.customer_old c where o.customerId=c.customerId and orderId=?";
    ...
    public static boolean saveOrder(Order order) {
        ...
        try {
            ...
            con = ConnectionManager.getConnection();
            String sql = "UPDATE orderinventories.order_old SET orderDate = ?, orderValue =?, taxAmount = ?, destinationCity = ?, destinationCountry = ? WHERE orderId = ?";
    ...
    public static boolean saveOrder(Order order, ArrayList products) {
        ...
        try {
            ...
            con = ConnectionManager.getConnection();
            String sql = "INSERT INTO orderinventories.order_old (orderDate, orderValue, customerId, taxAmount, destinationCity, destinationCountry) VALUES(?,?,?,?,?,?)";
    ...
    public static ArrayList getCountries() {
        ...
        try {
            ...
            con = ConnectionManager.getConnection();
            String sql = "SELECT * FROM countries_old";
            PreparedStatement ps = con.prepareStatement(sql);
            ResultSet rs = ps.executeQuery();
            while (rs.next()) {
    ...
    public static ArrayList getStates(String countryCode) {
        ...
        try {
            ...
            con = ConnectionManager.getConnection();
            String sql = "SELECT * FROM states_old where countryCode=?";
            PreparedStatement ps = con.prepareStatement(sql);
